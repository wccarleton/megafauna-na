...
for( n in 1:length(mfauna_sp)){
   load(paste("../Results/MCMC/NewGround/Regional/mcmc_samples_",mfauna_sp[n],"_ta_NGRIP_ensemble.RData",sep=""))
...
ggsave(filename="../Images/posteriors_NGRIP_ensemble_reg_c.png",
      device = "png",
      height = 20,
      width = 20,
      units = "cm",
