...
for( n in 1:length(mfauna_sp)){
   load(paste("../Results/MCMC/mcmc_samples_",
            mfauna_sp[n],"_hc_ta_NGRIP_ensemble.RData",
            sep=""))
...
ggsave(filename="../Images/posteriors_mastodon_ext.png",
      device = "png",
      height = 10,
      width = 20,
      units = "cm",
