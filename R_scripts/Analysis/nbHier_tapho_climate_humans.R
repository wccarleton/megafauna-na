...
load("../Data/rects_sample_arch_GL.RData")
rects_sample_arch <- rects_sample_arch_GL
...
X1 <- as.matrix(rece_sample_arch[,sample(2:dim(rece_sample_arch)[2],size=50)])
X1[which(is.na(X1))] <- 0
...
#save samples
save(samples,file=paste("../Results/MCMC/mcmc_samples_",sp,"_ta_hc_BroughtonNGRIP_GL.RData",sep=""))
